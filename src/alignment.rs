...
const FRAC_PI_180: f64 = PI / 180.;
const MAX_GEOMETRY_DEBUG_LEVEL: u8 = 2;
			...
			if i > 0 {
				...
				let ingoing_clothoid = FunctionCurve::new(Interval::UNIT, |s| {
					clothoid_point(
						...
						t_i,
						l_c_abs,
						f64::from(unit_vector_i.z.atan2(unit_vector_i.x)), // beta_i
						fresnel_scale,
						fresnel_scale_sign,
					)
				});
